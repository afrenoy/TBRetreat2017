...
\begin{frame}[label=commandline]
    ...
    \begin{itemize}
        \titem \textbf{\href{https://www.gnu.org/software/wget/}{wget}}
            \begin{itemize}
                \grayitem \href{https://www.gnu.org/software/wget/manual/wget.html#SEC_Contents}{\textbf{user manual}}
                \grayitem \href{run:../command_line_tools/wget_file_example.md}{\textbf{wget example}}
            \end{itemize}
